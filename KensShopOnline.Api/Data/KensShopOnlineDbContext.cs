...
namespace KensShopOnline.Api.Data
{
    public class KensShopOnlineDbContext:DbContext
    {
        public KensShopOnlineDbContext(DbContextOptions<KensShopOnlineDbContext> options) : base(options)
        {
